      ...
      <div className="space-y-20">
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            <span className="shrink-0 w-7 h-7 rounded-lg bg-[var(--brand-accent)]/10 border border-[var(--brand-accent)]/20 flex items-center justify-center">
              <svg className="w-3.5 h-3.5 text-[var(--brand-accent)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
        ...
        <section>
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-xs font-semibold text-[var(--brand-accent)] uppercase tracking-widest">Who It's For</h2>
          </div>
        ...
        <section>
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-xs font-semibold text-[var(--brand-accent)] uppercase tracking-widest">Features</h2>
          </div>
