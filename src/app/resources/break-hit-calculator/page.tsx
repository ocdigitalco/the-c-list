  ...
  return (
    <div className="h-full overflow-y-auto">
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <Link
          href="/sets"
          className="inline-flex items-center gap-1 text-xs text-[var(--brand-slate)] hover:text-[var(--brand-ink-soft)] transition-colors mb-8"
        >
        ...
        <h1 className="text-2xl font-normal text-[var(--brand-ink)] tracking-tight mb-4" style={{ fontFamily: "var(--brand-font-head)", fontSynthesisWeight: "none" }}>
          How the Break Hit Calculator Works
        </h1>
        <p className="text-[16px] text-[var(--brand-ink-soft)] leading-[1.75] mb-10">
        ...
        {/* Three Types of Odds */}
        <h2 className="text-lg font-bold text-[var(--brand-ink)] mt-12 mb-4">
          Three Types of Odds
        </h2>

        <h3 className="text-base font-semibold text-[var(--brand-ink-soft)] mt-8 mb-2">
          Any Card
        </h3>
        <p className="text-[16px] text-[var(--brand-ink-soft)] leading-[1.75] mb-6">
